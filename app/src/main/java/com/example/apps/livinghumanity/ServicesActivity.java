...
public class ServicesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            //Toast.makeText(getApplicationContext(), "You are in Service page.", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.nav_about_us) {
            startActivity(new Intent(ServicesActivity.this, AboutUsActivity.class));
            //Toast.makeText(getApplicationContext(), "About Us page is not ready.", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.nav_services) {
            Toast.makeText(getApplicationContext(), "You are in Services page", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_gallery) {
            startActivity(new Intent(ServicesActivity.this, GalleryActivity.class));
            //Toast.makeText(getApplicationContext(), "Gallery page is not ready.", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_faq) {
            startActivity(new Intent(ServicesActivity.this, FaqActivity.class));
            //Toast.makeText(getApplicationContext(), "FAQ page is not ready.", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_contact_us) {
            startActivity(new Intent(ServicesActivity.this, ContactUsActivity.class));
